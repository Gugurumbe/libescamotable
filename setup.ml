...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0805e9d5cbe6e982a67a7fac493eaa57) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/libescamotable/client";
                   ...
                   {
                      lib_modules = ["client/Escamotable"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "libescamotable-client";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "libescamotable-server";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/libescamotable/server";
                      bs_compiled_object = Best;
                      bs_build_depends =
                   ...
                   {
                      lib_modules = ["server/Escamotable"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "libescamotable-server";
                      lib_findlib_containers = []
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "5-m\170\234N}\166t|\168/5\019t&";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
